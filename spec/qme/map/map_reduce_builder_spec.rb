...
describe QME::MapReduce::Builder do
  it 'should produce valid JavaScript expressions for the query components' do
    ...
    builder.denominator.should eql('(this.measures["0043"].encounter>='+measure.parameters[:earliest_encounter].value.to_s+')')
    builder.population.should eql('(this.birthdate<='+measure.parameters[:earliest_birthdate].value.to_s+')')
